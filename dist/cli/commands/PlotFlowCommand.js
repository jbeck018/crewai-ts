...
export class PlotFlowCommand extends Command {
    name = 'plot-flow';
    description = 'Generate a visual representation of a flow';
    syntax = '<flow-file-path> [options]';
    examples = [
    ...
    async execute(args) {
        ...
        try {
            ...
            const outputPath = await plotFlow(flow, parsedArgs.filename || FlowClass.name, parsedArgs.output);
...
//# sourceMappingURL=PlotFlowCommand.js.map