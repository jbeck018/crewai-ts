...
function validateCondition(condition) {
    ...
    if (typeof condition === 'function') {
        ...
        console.warn('Function conditions work differently between Python and TypeScript implementations. ' +
 ...
 */
export function start(condition) {
 ...
 */
export function listen(condition) {
 ...
 */
export function router(condition) {
    // Input validation for better error messages
    if (!condition) {
    ...
    for (const condition of conditions) {
        try {
            ...
            if (typeof condition === 'string') {
                ...
                throw new FlowValidationError('Function conditions are not supported in or_() for cross-platform compatibility');
            }
        }
        catch (error) {
    ...
    for (const condition of conditions) {
        try {
            ...
            if (typeof condition === 'string') {
                ...
                throw new FlowValidationError('Function conditions are not supported in and_() for cross-platform compatibility');
            }
        }
        catch (error) {
            // Enhanced error handling with context
