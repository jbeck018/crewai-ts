...
export class FlowDependencyVisualizer {
    ...
    async visualize() {
        ...
        const outputPath = path.join(this.options.outputPath, `${this.options.filename}.html`);
    ...
    applyOptimizations(graphData) {
        ...
        if (graphData.nodes.length > maxNodeSize) {
            ...
            graphData.edges = graphData.edges.filter(e => nodeIds.has(e.from) && nodeIds.has(e.to));
        }
     ...
     */
    generateVisualizationHtml(graphData) {
...
//# sourceMappingURL=FlowDependencyVisualizer.js.map