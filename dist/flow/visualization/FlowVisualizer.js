...
import { COLORS, LAYOUT_CONFIG, NODE_STYLES } from './config.js';
import { addEdgesToNetwork, addNodesToNetwork, calculateNodeLevels, computePositions } from './utils.js';
...
export class FlowVisualizer {
     ...
     */
    async generateVisualization(filename = 'flow_visualization') {
        let network;
        try {
 ...
 * @returns Path to the generated HTML file
 */
export async function plotFlow(flow, filename = 'flow_visualization', outputDir) {
