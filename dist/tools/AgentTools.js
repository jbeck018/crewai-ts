 ...
 */
class AgentDelegationTool extends Tool {
    agent;
    delegationPath;
    constructor(agent, delegationPath = []) {
        super({
    ...
    async _execute(input) {
        ...
        const result = await this.agent.executeTask(delegatedTask, // We're simulating a task object here
        context);
